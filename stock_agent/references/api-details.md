...
| 服务 | 地址 | Token | 用途 |
|------|------|-------|------|
| AI Hedge Fund | `https://finance.aifoundrys.com:7443/aihedgefund` | `xG8XyygVqe9OtV5WcQH8phECIQ8wiIZrGaziiuOJtJQ` | 投资大师分析 + 自动化回测 |
| TradingAgents | `https://finance.aifoundrys.com:7443/tradingagents` | `ITBVOCmV4m2Wm1qHL-yRsxE4D3QVMQXPWLWxSIdBHKo` | 深度文本分析 |
| 回测引擎 | `https://finance.aifoundrys.com:7443/ziplime` | `NoHKWxHvaFKdsNutAKGjJWD_RmDPipxurgT_U9H_Oh0` | 自定义策略回测 |
| Alpaca Trading | `https://finance.aifoundrys.com:7443/alpacatrading` | `JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I=` | 模拟盘交易执行 |

所有 API 通过 HTTPS 调用，域名为 `finance.aifoundrys.com:7443`。

---

## AI Hedge Fund API（/aihedgefund）

### GET /hedge-fund/agents — 查看可用投资大师

```bash
curl -s https://finance.aifoundrys.com:7443/aihedgefund/hedge-fund/agents \
...
```bash
curl -s -X POST https://finance.aifoundrys.com:7443/aihedgefund/api/v1/analyze \
  -H "Authorization: Bearer xG8XyygVqe9OtV5WcQH8phECIQ8wiIZrGaziiuOJtJQ" \
...
```bash
curl -s https://finance.aifoundrys.com:7443/aihedgefund/api/v1/tasks/<task_id> \
  -H "Authorization: Bearer xG8XyygVqe9OtV5WcQH8phECIQ8wiIZrGaziiuOJtJQ"
```
...
```bash
curl -s -X POST https://finance.aifoundrys.com:7443/aihedgefund/hedge-fund/backtest \
  -H "Authorization: Bearer xG8XyygVqe9OtV5WcQH8phECIQ8wiIZrGaziiuOJtJQ" \
  -H "Content-Type: application/json" \
  -d '{
    "tickers": ["AAPL"],
...
```bash
curl -s https://finance.aifoundrys.com:7443/aihedgefund/api/v1/analysts \
  -H "Authorization: Bearer xG8XyygVqe9OtV5WcQH8phECIQ8wiIZrGaziiuOJtJQ"
```
...
## TradingAgents API（/tradingagents）

### POST /api/v1/analyze — 提交分析任务

```bash
curl -s -X POST https://finance.aifoundrys.com:7443/tradingagents/api/v1/analyze \
...
```bash
curl -s https://finance.aifoundrys.com:7443/tradingagents/api/v1/tasks/<task_id> \
  -H "Authorization: Bearer ITBVOCmV4m2Wm1qHL-yRsxE4D3QVMQXPWLWxSIdBHKo"
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/tradingagents/api/v1/tasks \
  -H "Authorization: Bearer ITBVOCmV4m2Wm1qHL-yRsxE4D3QVMQXPWLWxSIdBHKo"
```
...
```bash
curl -s -X POST https://finance.aifoundrys.com:7443/ziplime/api/v1/strategies/upload \
...
```bash
curl -s -X POST https://finance.aifoundrys.com:7443/ziplime/api/v1/ingest \
  -H "Authorization: Bearer NoHKWxHvaFKdsNutAKGjJWD_RmDPipxurgT_U9H_Oh0" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST https://finance.aifoundrys.com:7443/ziplime/api/v1/backtest \
  -H "Authorization: Bearer NoHKWxHvaFKdsNutAKGjJWD_RmDPipxurgT_U9H_Oh0" \
  -H "Content-Type: application/json" \
  -d '{
    "symbols": ["AAPL"],
...
```bash
curl -s https://finance.aifoundrys.com:7443/ziplime/api/v1/bundles \
  -H "Authorization: Bearer NoHKWxHvaFKdsNutAKGjJWD_RmDPipxurgT_U9H_Oh0"
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/ziplime/api/v1/strategies \
  -H "Authorization: Bearer NoHKWxHvaFKdsNutAKGjJWD_RmDPipxurgT_U9H_Oh0"
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/ziplime/api/v1/tasks/<task_id> \
  -H "Authorization: Bearer NoHKWxHvaFKdsNutAKGjJWD_RmDPipxurgT_U9H_Oh0"
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/aihedgefund/api/v1/health  # AI Hedge Fund
curl -s https://finance.aifoundrys.com:7443/tradingagents/api/v1/health  # TradingAgents
curl -s https://finance.aifoundrys.com:7443/ziplime/api/v1/health  # 回测引擎
curl -s https://finance.aifoundrys.com:7443/alpacatrading/health          # Alpaca Trading
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/alpacatrading/health \
...
```bash
curl -s https://finance.aifoundrys.com:7443/alpacatrading/account \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
# 市价买入
curl -s -X POST https://finance.aifoundrys.com:7443/alpacatrading/orders \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I=" \
  -H "Content-Type: application/json" \
  -d '{
    "symbol": "AAPL",
...
```bash
# 获取所有订单
curl -s https://finance.aifoundrys.com:7443/alpacatrading/orders \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="

# 带过滤参数
curl -s "https://finance.aifoundrys.com:7443/alpacatrading/orders?status=open&limit=10" \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
curl -s -X DELETE https://finance.aifoundrys.com:7443/alpacatrading/orders/<order_id> \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/alpacatrading/positions \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
curl -s -X DELETE https://finance.aifoundrys.com:7443/alpacatrading/positions/AAPL \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
curl -s -X DELETE https://finance.aifoundrys.com:7443/alpacatrading/positions \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
curl -s https://finance.aifoundrys.com:7443/alpacatrading/quotes/AAPL \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
...
```bash
curl -s "https://finance.aifoundrys.com:7443/alpacatrading/bars/AAPL?timeframe=1Day&limit=5" \
  -H "Authorization: Bearer JISCaUdXQEyzIQmVwpe1HEh++6CFDVm+Aj1X9snsj4I="
```
